...
$1.3\times10^{-3}$) and report a negative diagnostic: although the
activation is approximately equivariant by construction, the
\texttt{so33\_equivariant} architecture collapses reproducibly to OOD AUC
$0.663 \pm 0.001$, which we discuss as an open question about learned
$\Gamma$ drift.
\end{abstract}

...
into the readout feature as a non-invariant denominator. Disabling the
bound restores OOD AUC to $1.000$, giving a fully equivariant
architecture that matches \texttt{eta\_invariants} on the headline task.
\end{abstract}
